		...
		<div className="flex relative md:pl-10">
			...
			<div className="flex items-center flex-row relative">
				<motion.div
					...
					className="w-[4px] h-full increase2"
				/>
				<Image
					alt=""
					aria-hidden="true"
			...
			<div className="lg:pl-24 md:pl-16 pl-6">
				<div className="flex max-md:flex-col-reverse my-8 items-center lg:gap-x-5 sm:my-12 md:my-16 pb-6 md:pb-20 md:flex-row">
					<div className="py-4 mb-2 w-full">
						<motion.div
							...
							<h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]">
								...
								помогают быстрее создавать микшер с тонкой настройкой, скачать плагины можно на нашем сайте
							</h2>
							<a
					...
					<motion.div
						...
						<div className="relative">
							<div className="relative">
								<div className="md:absolute z-[1] top-[-100px] lg:top-[-250px] right-0 shadow-2xl">
									<Image
										src={criticalSec}
										alt=""
										loading="lazy"
				...
				<motion.div
					...
					<div className="py-4 text-left">
						<div className="z-[1] inline-block rounded-full px-2 border-2 border-[#33b3ae] relative font-medium bg-gradient-to-r from-[#33b3ae] to-[#33b3ae] bg-clip-text text-transparent">
							<span className="font-semibold text-[12px]">Знаете ли вы?</span>
						</div>
						<h3 className="text-[#33b3ae] mb-2 mt-3 lg:text-6xl md:text-5xl text-3xl font-medium">
							В 7 раз быстрее
						</h3>
						<p className="mb-3 md:text-xl text-base font-medium text-white">
							устраняются шумы и искажения при использовании продвинутых алгоритмов аудиоредактора.
						</p>
					</div>
				</motion.div>
			</div>
