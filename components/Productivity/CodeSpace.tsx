						...
						<motion.div
							...
							<h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]">
								<span className="font-semibold text-white">
									Ускорьте работу над аудио
								</span>{" "}
								с помощью интеллектуального помощника, который сокращает время
								редактирования до 55%.
							</h2>
							<Link
					...
					<div className="w-full">
						<div className="py-4 text-left">
							...
							<p className="mb-3 md:text-xl text-base font-medium text-white">
								в производительности редактирования после трёх <br /> лет
								использования современных аудиотехнологий
							</p>
						</div>
						<Link
							onMouseEnter={() => setHovered(true)}
