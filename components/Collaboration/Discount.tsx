						...
						<motion.div
							...
							<h2 className="mb-4 text-2xl max-lg:text-[20px] max-md:w-10/12 lg:w-full w-full text-[#7d8590]">
								<span className="font-semibold text-white">
									Гибкое управление сессиями и эффектами
								</span>{" "}
								позволяет подстроить процесс работы под ваш стиль прямо в рабочем пространстве.
							</h2>
							<Link
								...
								Откройте возможности редактирования
								<svg
				...
				<motion.div
					...
					<div className="py-4 text-left">
						...
						<p className="mb-3 md:text-xl text-base font-medium text-white">
							быстрее адаптация новых пользователей <br /> при работе в NoirSound<sup>2</sup>
						</p>
					</div>
				</motion.div>
			</div>
