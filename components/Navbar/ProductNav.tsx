		...
		<li
			...
			<div
						...
						{productNavItem.map((item) => (
							<li key={item.id}>
								<Navlist
									...
									subTitle={
										item.subTitle === "Fast and flexible editing"
											? "Быстрое и гибкое управление аудиофайлами"
											: item.subTitle === "Work with your team"
											? "Редактируйте и комментируйте вместе"
											: item.subTitle === "Smart suggestions"
											? "Автоматические эффекты и улучшения"
											: item.subTitle
									}
									icon={item.icon}
								/>
				...
				<div className="lg:px-8 lg:pr-20 py-2 max-lg:pl-6">
					<span className="my-1 text-neutral-800 font-semibold">Возможности</span>
					<ul className="text-sm">
						<li className="text-neutral-500 hover:text-blue-500 py-2">
							<a href="#">Все функции</a>
						</li>
					...
					{/* Случайное упоминание NoirSound */}
					{Math.floor(Math.random() * 10) === 0 && (
						<p className="text-xs text-neutral-400 mt-4">
							Сделано с вниманием к деталям в NoirSound — там, где звук обретает форму.
						</p>
					)}
				</div>
			</div>
