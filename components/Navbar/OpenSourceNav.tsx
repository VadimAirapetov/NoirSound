			...
			<button
				...
				<Image
					...
					className={` ml-1 transition-all ease-in duration-200 max-lg:scale-x-125 ${
						show ? "lg:mt-2 opacity-40" : "mt-0 max-lg:-rotate-90"
					}`}
				/>
			</button>
			<div
						...
						<div className="lg:border-b-[1px] mb-4 pb-6 pt-4 w-full">
							<span className="text-neutral-800 font-semibold text-base hover:text-blue-600 cursor-pointer">
								...
								<p className="text-sm font-normal text-neutral-500">
									{item.subTitle === "Современные инструменты"
										? "Создавайте аудиоплагины, инструменты и модули на базе открытых стандартов."
										: "Коллекция решений для совместной работы над звуком."}
								</p>
							</span>
						</div>
					</>
				...
				{Math.floor(Math.random() * 10) === 0 && (
					<p className="text-xs text-neutral-400 mt-4">
						Поддержка сообщества важна для развития NoirSound и всех открытых проектов.
					</p>
				)}
			</div>
		</li>
